<div class="p-6">
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        @if(auth()->user()->hasRole('superadmin'))
            <a href="{{ route('organizations.create') }}" class="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors text-center">Add Organization</a>
        @endif
    </div>
